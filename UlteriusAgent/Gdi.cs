...
namespace UlteriusAgent.Api
{
    internal class Gdi
    {
        ...
        [DllImport("gdi32.dll")]
        public static extern int StretchBlt(IntPtr hDestDC, int x, int y, int nWidth, int nHeight, IntPtr hSrcDC,
            int xSrc, int ySrc, int nSrcWidth, int nSrcHeight, int dwRop);
        ...
        [DllImport("gdi32.dll")]
        public static extern IntPtr CreateDIBSection(IntPtr hdc, [In] ref WinApi.Bitmapinfo pbmi, uint pila,
