...
namespace UlteriusServer.Api.Win32.WindowsInput
{
    ...
    public class KeyboardSimulator : IKeyboardSimulator
    {
        ...
        /// </summary>
        /// <param name="inputSimulator">The <see cref="Input" /> that owns this instance.</param>
        ...
        ///     The <see cref="InvalidOperationException" /> to use for dispatching
        ///     <see cref="Input" /> messages.
        /// </param>
        /// <exception cref="Input">If null is passed as the <paramref name="messageDispatcher" />.</exception>
        ...
        /// <summary>
        ///     Sends the list of <see cref="IInputMessageDispatcher" /> messages using the <see cref="IInputMessageDispatcher" />
        ///     instance.
        /// </summary>
        /// <param name="inputList">The <see cref= Systemy"/> of <see cref="Input" /> messages to send.</param>
