...
{
    /// <summary>
    ///     An implementation of <see cref="UlteriusServer.Api.Win32.WindowsInput.IInputDeviceStateAdaptor" /> for Windows by calling the native
    ///     <see cref="NativeMethods.GetKeyState" /> and <see cref="NativeMethods.GetAsyncKeyState" /> methods.
    /// </summary>
    public class WindowsInputDeviceStateAdaptor : UlteriusServer.Api.Win32.WindowsInput.IInputDeviceStateAdaptor
    {
        /// <summary>
