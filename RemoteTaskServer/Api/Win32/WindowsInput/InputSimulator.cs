...
{
    /// <summary>
    ///     Implements the <see cref="IInputSimulator" /> interface to simulate Keyboard and Mouse input and provide the state
    ///     of those input devices.
    /// </summary>
    public class InputSimulator : IInputSimulator
    {
        ...
        ///     <see cref="KeyboardSimulator" />, <see cref="MouseSimulator" /> and <see cref="WindowsInputDeviceStateAdaptor" />
        ///     instances.
        /// </summary>
